...
SOURCEFILES := dev_table.c i2c.c init.c main.c parsers/binary.c parsers/hex.c port.c serial_common.c serial_w32.c stm32.c utils/utils.c
EXTERNAL_LIBS := 
...
$(BINARYDIR)/binary.o : parsers/binary.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/hex.o : parsers/hex.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/utils.o : utils/utils.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
